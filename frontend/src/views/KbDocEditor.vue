...
import { KbTableCell } from '../editor/kbTableCellExtension'
import { KbTableHeader } from '../editor/kbTableHeaderExtension'
import { useMessage, useIcon, useRoute, useRouter } from '@keqi.gress/plugin-bridge'
import { KbSlashCommands } from '../editor/kbSlashExtension'
import type { KbSlashHandlers } from '../editor/kbSlashItems'
import { KbIframe } from '../editor/kbIframeExtension'
import { KbImageGallery } from '../editor/kbImageGalleryExtension'
import { KbLayoutSection } from '../editor/kbLayoutSectionExtension'
import { sanitizeKbTipColor } from '../editor/kbTipLayoutStyle'
import { KbTabbedPanel } from '../editor/kbTabbedPanelExtension'
import { KbCodeBlock } from '../editor/kbCodeBlockExtension'
import { KbImage } from '../editor/kbImageExtension'
import { KbIndent } from '../editor/kbIndentExtension'
import { KbGrid, KbGridColumn } from '../editor/kbGridExtension'
import { normalizeImageUrl, normalizeVideoEmbedUrl, normalizeWebEmbedUrl } from '../editor/kbEmbedUrls'
import { kbApi } from '../api/kb'
import { htmlToMarkdown, markdownToHtml } from '../editor/mdHtml'
import { outlineFromEditor, type OutlineItem } from '../editor/outlineFromTiptap'
...
async function loadDocTree() {
  ...
  try {
    docTree.value = await kbApi.tree(siteKey.value || undefined)
  } catch (e: any) {
    docTree.value = []
